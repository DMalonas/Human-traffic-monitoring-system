...
import communication.ParkNodeCommunicator;
import utilities.MessageTypes;
import utilities.SharedResourceUtilities;
...
public class ParkNode {
	 ...
	 *     ELECTION-ACK [nodeID, metricValue], or COORDINATOR.   WHEN A NODE RECEIVES THE COORDINATOR MESSAGE 
	 *     IT BROADCASTS IT EVERYWHERE EVEN TO ITS PARENT AND THAT WHILE IT ADDS A LITTLE 
	 *     BIT OF OVERHEAD IT ALSO MAKE THE SYSTEM MORE FAULT TOLERANCE THROUGH REDUNDANCY,
	 *      SINCE IT CATERS FOR THE CASE THAT A NODE GOES DOWN.
